...
run_la <- function(i, ndev, nval, n.para, beta0, beta,
  ...
  data.dev <- generate_ss(ndev, n.para, beta0, beta, n.true = n.true)
  data.val <- generate_ss(nval, n.para, beta0, beta, n.true = n.true)
  ...
  p_ref_draws <- posterior_epred(ref_fit, newdata = xval, ndraws = 400)
